...
output_prefix='| '
# systemless:  http://forum.xda-developers.com/showpost.php?p=64161125&postcount=3
...
# vanilla:     http://forum.xda-developers.com/apps/supersu/stable-2016-09-01supersu-v2-78-release-t3452703
...
superuser_link="${vanilla_supersu_link}"
